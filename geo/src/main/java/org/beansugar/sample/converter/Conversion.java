package org.beansugar.sample.converter;
...
//	private static double sm_EccSquared = 6.69437999013e-03;
	 ...
	 */
	/*
	 * function btnToUTM_OnClick () { var xy = new Array(2);
	 * 
	 * if (isNaN (parseFloat (document.frmConverter.txtLongitude.value))) {
	 * alert ("Please enter a valid longitude in the lon field."); return false;
	 * }
	 * 
	 * lon = parseFloat (document.frmConverter.txtLongitude.value);
	 * 
	 * if ((lon < -180.0) || (180.0 <= lon)) { alert
	 * ("The longitude you entered is out of range.  " +
	 * "Please enter a number in the range [-180, 180)."); return false; }
	 * 
	 * if (isNaN (parseFloat (document.frmConverter.txtLatitude.value))) { alert
	 * ("Please enter a valid latitude in the lat field."); return false; }
	 * 
	 * lat = parseFloat (document.frmConverter.txtLatitude.value);
	 * 
	 * if ((lat < -90.0) || (90.0 < lat)) { alert
	 * ("The latitude you entered is out of range.  " +
	 * "Please enter a number in the range [-90, 90]."); return false; }
	 * 
	 * // Compute the UTM zone. zone = Math.floor ((lon + 180.0) / 6) + 1;
	 * 
	 ...
	 * document.frmConverter.txtZone.value = zone; if (lat < 0) // Set the S
	 * button. document.frmConverter.rbtnHemisphere[1].checked = true; else //
	 * Set the N button. document.frmConverter.rbtnHemisphere[0].checked = true;
	 * 
	 * 
	 * return true; }
	 */
	 ...
	 */
	/*
	 * private void btnToGeographic_OnClick () { double[] latlon; double x, y,
	 * zone, southhemi;
	 * 
	 * if (isNaN (parseFloat (document.frmConverter.txtX.value))) { alert
	 * ("Please enter a valid easting in the x field."); return false; }
	 * 
	 * x = parseFloat (document.frmConverter.txtX.value);
	 * 
	 * if (isNaN (parseFloat (document.frmConverter.txtY.value))) { alert
	 * ("Please enter a valid northing in the y field."); return false; }
	 * 
	 * y = parseFloat (document.frmConverter.txtY.value);
	 * 
	 * if (isNaN (parseInt (document.frmConverter.txtZone.value))) { alert
	 * ("Please enter a valid UTM zone in the zone field."); return false; }
	 * 
	 * zone = parseFloat (document.frmConverter.txtZone.value);
	 * 
	 * if ((zone < 1) || (60 < zone)) { alert
	 * ("The UTM zone you entered is out of range.  " +
	 * "Please enter a number in the range [1, 60]."); return false; }
	 * 
	 * if (document.frmConverter.rbtnHemisphere[1].checked == true) southhemi =
	 * true; else southhemi = false;
	 * 
